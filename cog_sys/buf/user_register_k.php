...
<div id="wrap">
        ...
        <p style="text-align: right"><button><a href="../psw_login/index.php" style="text-decoration:none;">戻る</a></button></p>
...
<!-- <button>仮会員登録</button> -->
  ...
  <dl>
      ...
      <?php if ((isset($view_data['error_must_birth'])) && (true === $view_data['error_must_birth'])): ?>
              ...
              <!-- <input type="text" name="birth" value="<?php echo h($view_data['birth']); ?>"> -->
