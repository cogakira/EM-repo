...
// $stmt = $dbh->prepare('select sum(seikyu) as seikyu from uriage where mcode = :mcode and shukko = 0;');
$stmt = $dbh->prepare('select sum(seikyu) as seikyu from uriage where mcode = :mcode;');
...
// $sql = 'SELECT * FROM uriage where mcode = :mcode and shukko = 0 order by chumonbi desc,koshinbi desc;';
$sql = 'SELECT * FROM uriage where mcode = :mcode order by chumonbi desc,koshinbi desc;';
