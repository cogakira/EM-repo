...
// teiki_out($mcode);
$dbh = get_dbh();
$sqlteiki = 'select * from teiki order by hjunkyocd,shohincd;';
...
<div id="wrap">
  <div id="head">
    ...
    <div style="text-align:right;font-size:20px;"><input value="前に戻る" onclick="history.back();" type="button"></div>
<h2 style="font-size:20px;margin-left:30px;" >現在定期数</h2>
  </div> 
  <div id="content">
  <table>
  ...
  <?php foreach ($teikilst as $teiki) : ?>
    ...
    <?php $sqlsum = 'select count(*) as id from teiki 
      where hjunkyocd = :hjunkyocd and shohincd = :shohincd and keikucd = :keikucd ;'; ?>
