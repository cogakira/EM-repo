              ...
              <table>
                <tbody>
                  ...
                  <tr>
                    ...
                    <button style="margin-top:20px;"><a style="text-decoration:none;" href="teiki_kai_insert_fin.php">OK (定期として設定)</a></button>
                    <div style="text-align: right;"><button><a style="text-decoration:none;" href="./teiki_in_kai.php">リセットして戻る</a></button></div>
