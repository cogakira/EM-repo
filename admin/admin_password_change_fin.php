...
<?php endif; ?>
<?php if ( (isset($view_data['error_invalid_id']))&&(true === $view_data['error_invalid_id']) ) : ?>
    <span class="text-danger">idが存在しません<br></span>
<?php endif; ?>
...
<?php endif; ?>
  ...
  <tr>
    <th>ユーザID(ログインID)
    <td><input name="id" value="<?php echo h($id); ?>" readonly>
  <tr>
    <th>パスワード
