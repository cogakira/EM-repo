...
// ログイン処理(共通化)
$login_flg = login($user_input_data['password'], $datum, 'admin_user_login_lock');
...
$_SESSION['admin_auth']['id'] = $datum['id'];
$_SESSION['admin_auth']['mname'] = $datum['mname'];
